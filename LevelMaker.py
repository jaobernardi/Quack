...
def main_loop():
	...
	while global_status['running']:
		...
		if keys[pygame.K_a]: global_status["desloc"] -= 32
		if keys[pygame.K_d]: global_status["desloc"] += 32
		...
		for event in pygame.event.get():
			if event.type == pygame.MOUSEBUTTONDOWN:
				saved_blocks.append([img, x[pygame.mouse.get_pos()[0]+global_status["desloc"]], y[pygame.mouse.get_pos()[1]], type])
